    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                int result1 = ((String)stock1.get("name")).compareTo((String)stock2.get("name"));
            ...
            public int compare(Stock stock1, Stock stock2) {
                ...
                if(stock1.containsKey("change")){
                    ...
                    a = ((Double) stock1.get("last")) - ((Double) stock1.get("open"));
                }

                if(stock2.containsKey("change")){
                    b = (Double) stock2.get("change");
                }else{
                    b = ((Double) stock2.get("last")) - ((Double) stock2.get("open"));
                }
