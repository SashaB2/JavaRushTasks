...
public class Solution {
    ...
    private class TaskDataProvider implements DbDataProvider{
        ...
        public void refreshAllData(Map criteria) {
            Map taskMapCriteria = MockView.getFakeTaskCriteria();
            Solution.this.tasks = MockDB.getFakeTasks(taskMapCriteria);
        }
    }
    private class NameDataProvider implements DbDataProvider{
        @Override
        public void refreshAllData(Map criteria) {
            Map nameMapCriteria = MockView.getFakeNameCriteria();
            Solution.this.names = MockDB.getFakeNames(nameMapCriteria);
        }
    }
